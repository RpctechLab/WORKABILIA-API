...
@Entity
@Table(name="hs_posizioni_lavorative_chiuse")
public class ClosedJobPositions {
	@Id
	...
	public ClosedJobPositions() {}

	public ClosedJobPositions(int id, Integer idCreatorUser, Integer idState, Integer idCompartment, String code,
	...
	public ClosedJobPositions(JobPositions jp) {
		this.idCreatorUser = jp.getIdCreatorUser();
		this.idState = jp.getIdState();
		this.idCompartment = jp.getIdCompartment();
		this.code = jp.getCode();
		this.task = jp.getTask();
		this.name = jp.getName();
		this.description = jp.getDescription();
		this.activity = jp.getActivity();
		this.idProvince = jp.getIdProvince();
		this.dateEntered = jp.getDateEntered();
		this.lastModificationDate = jp.getLastModificationDate();
	}
	...
	public void setProvince(Integer idProvince) {
		this.idProvince = idProvince;
	}
